...
It is possible to add missing data and process your data further into a format suitable for spatial ecological analyses.  
...
# 9. Create community matrices
Only use matched species names?  
Only use complete organisms, no isPartial?  
