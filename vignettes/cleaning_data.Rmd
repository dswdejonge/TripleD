...
The RWS data do not have a cruise ID, so instead they are named RWS<databasenr>. For the RWS data 2018, stations with a failed dredge were removed, to prevent double stationIDs.
...
RWS2018: "Position_x, begin"	"Position_y, begin" are Lon_start_DD and Lat_start_DD.
...
test_Lavaleye: Not available. 
RWS2018: "Position_x, eind"	"Position_y, eind" are Lon_stop_DD and Lat_stop_DD.
...
RWS2018: "COORD_Y" is Lat_DD_midpt and "COORD_X" is Lon_DD_midpt.
...
RWS2018: The variable "AMT_MEAS" is the area that was measured. Because the blade width is 20 cm, the track length can be deduced from area and blade width (all track lengths are 100m).
...
RWS2018: Blade width assumed to be 20 cm?
...
RWS2018: Specifically given in original data file, so set to 0.
