...
#' "Lat_DD_midpt", "Lat_start_DD", "Lat_stop_DD", "Lon_DD_midpt", "Lon_start_DD", "Lon_stop_DD".
...
collect_bathymetry <- function(stations, buffer = 2, resolution = 1){
  ...
  all_Lat <- unlist(stations[,c("Lat_DD_midpt", "Lat_start_DD", "Lat_stop_DD")])
  all_Lon <- unlist(stations[,c("Lon_DD_midpt", "Lon_start_DD", "Lon_stop_DD")])
